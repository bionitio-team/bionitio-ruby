[![travis](https://travis-ci.org/bionitio-team/bionitio-ruby.svg?branch=master)](https://travis-ci.org/bionitio-team/bionitio-ruby)
...
```
$ git clone https://github.com/bionitio-team/bionitio-ruby
```
